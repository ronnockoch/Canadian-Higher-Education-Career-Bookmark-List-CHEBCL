...
1. Download all of the repository code clicking on the green CODE ![](resources/images/code-button.png?raw=true) button and selecting 'Download Zip'. You will need to extract it using an archive tool such a [7Zip](https://www.7-zip.org/).
